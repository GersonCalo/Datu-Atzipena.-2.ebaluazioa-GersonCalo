package damci.main.xml.toMongo;
...
public class XMLToMongo {
    public static void main(String[] args) {
        try (MongoClient mongoClient = MongoClients.create("mongodb://localhost:27017")) {
            ...
            Path xmlFilePath = Paths.get("C:\\Users\\gerson\\Documents\\DatuAtzipenaDoc\\Datu-Atzipena.-2.ebaluazioa-GersonCalo\\data\\xml\\fifa_testBi.xml");  // Reemplaza con la ruta real
