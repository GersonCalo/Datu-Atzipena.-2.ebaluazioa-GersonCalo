    ...
    private static void writeToXML(List<Document> documents) {
        try {
            ...
            for (Document document : documents) {
                ...
                Document playerData = (Document) document.get("player");
            ...
            FileWriter xmlWriter = new FileWriter("C:\\Users\\gerson\\Documents\\DatuAtzipenaDoc\\Datu-Atzipena.-2.ebaluazioa-GersonCalo\\data\\xml\\fifa_testfromMongo.xml");
